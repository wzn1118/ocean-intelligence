...
export const codexApi = {
  ...
  reportStatus: (threadId: string, reportId: string) => runtimeRequest<{
    ...
    visualCount: number;
    minimumVisuals: number;
    quality: { markdownBytes: number; htmlBytes: number; headingCount: number; figureCount: number; uniqueChartTypes: number; chartMetadataOk: boolean; chartDiversityOk: boolean; scientificChartFamiliesOk: boolean; chartSemanticsOk: boolean; professionalVisualizationOk: boolean; figureInterpretationCount: number; completeFigureInterpretationCount: number; figureInterpretationOk: boolean; waveEnergySemanticsOk: boolean; crossVariableConsistencyOk: boolean; operationalImpactOk: boolean; physicalRealityInterpretationOk: boolean; anomalyRankingOk: boolean; zoneAnomalyCoverageOk: boolean; collocatedPointInventoryOk: boolean; collocationMethodOk: boolean; independentValidationOk: boolean; crossVariableMatrixOk: boolean; lagAnalysisOk: boolean; falsificationPathOk: boolean; anomalyLinkageOk: boolean; editorialStyleOk: boolean; editorialStyleViolationCount: number; defensiveStyleMatches: string[]; cannedTransitionMatches: string[]; colloquialSingleVerbMatches: string[]; analyticalClaims: number; comparisons: number; evidenceMarkers: number; zoneCoverage: number; pointZoneCoverage: number; centerPointOk: boolean; geographyResolutionOk: boolean; pointInventoryOk: boolean; pointAuditOk: boolean; windTimeSemanticsOk: boolean; windVectorSemanticsOk: boolean; windSpatialMethodOk: boolean; windComparisonOk: boolean; windPointValidationOk: boolean; variableSectionsOk: boolean; variableSectionChecks: Record<string, boolean>; physicalRotationOk: boolean; physicalScaleAnalysisOk: boolean; physicalBalanceOk: boolean; physicalProvenanceOk: boolean; physicalZoneRegimeOk: boolean; physicalUncertaintyOk: boolean; textbookReferenceOk: boolean; physicalOceanographyOk: boolean };
  }>(
