...
for seriesIndex = 1:numel(valueVariables)
    ...
    validMask = ~missingMask & qcAcceptedMask & uncertaintyCompleteMask;
    ...
    uncertaintyHandles{seriesIndex} = plot_uncertainty(axesHandle,rowTimes,values, ...
        validMask,gapThreshold,uncertainty,seriesIndex,lineColors(seriesIndex,:));
    ...
    missingMasks(:,seriesIndex) = missingMask | ~uncertaintyCompleteMask;
