...
forged = entries;
forged(2).unmeasured_text_objects(1).role = "legend.title";
must_reject_manifest(manifestPath, forged, "UnmeasuredTextEvidence", manifestDigest);
forged = entries;
forged(2).unmeasured_text_objects(1).class = "matlab.graphics.illustration.legend.Text";
must_reject_manifest(manifestPath, forged, "UnmeasuredTextEvidence", manifestDigest);
forged = entries;
forged(2).unmeasured_text_objects(1).role = "legend.subtitle";
forged(2).unmeasured_text_objects(1).class = "matlab.graphics.illustration.legend.Text";
must_reject_manifest(manifestPath, forged, "UnmeasuredTextEvidence", manifestDigest);
forged = entries;
