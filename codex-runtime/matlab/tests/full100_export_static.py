...
required = {
    ...
    "oi_annotate_svg.m": ["DocumentBuilderFactory", "setNamespaceAware(true)", "xmlwrite",
                          "viewBox", "aria-label", "setAttribute",
                          ...
                          "setExpandEntityReferences(false)", "load-external-dtd', false"],
    "oi_write_manifest.m": [
