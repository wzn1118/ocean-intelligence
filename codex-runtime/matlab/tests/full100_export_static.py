...
required = {
    "oi_export_figure.m": [
        ...
        "color_accessibility_audit", "aria-label", "ExportSVG",
    ],
    "oi_write_manifest.m": [
        "refresh_artifact_metadata", "assert_artifacts_unchanged",
...
for marker in [
    "embedded_dpi_x", "exports.pdf.width", "exports.svg.width",
    "repaired", "oi_sha256_file",
]:
